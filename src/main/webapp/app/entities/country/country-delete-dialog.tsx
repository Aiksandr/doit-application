...
export const CountryDeleteDialog = (props: ICountryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="doitApplicationApp.country.delete.question">
        <Translate contentKey="doitApplicationApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
