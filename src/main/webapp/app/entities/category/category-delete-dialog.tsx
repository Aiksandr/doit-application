...
export const CategoryDeleteDialog = (props: ICategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="doitApplicationApp.category.delete.question">
        <Translate contentKey="doitApplicationApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
