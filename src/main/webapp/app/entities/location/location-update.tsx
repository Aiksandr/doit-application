...
export const LocationUpdate = (props: ILocationUpdateProps) => {
  ...
  const { locationEntity, countries, clients, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="doitApplicationApp.location.home.createOrEditLabel">
            <Translate contentKey="doitApplicationApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : locationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="cityLabel" for="location-city">
                  <Translate contentKey="doitApplicationApp.location.city">City</Translate>
                </Label>
                <AvField id="location-city" type="text" name="city" />
              </AvGroup>
              <AvGroup>
                <Label id="areaLabel" for="location-area">
                  <Translate contentKey="doitApplicationApp.location.area">Area</Translate>
                </Label>
                <AvField id="location-area" type="text" name="area" />
              </AvGroup>
              <AvGroup>
                <Label id="streetAddressLabel" for="location-streetAddress">
                  <Translate contentKey="doitApplicationApp.location.streetAddress">Street Address</Translate>
                </Label>
                <AvField id="location-streetAddress" type="text" name="streetAddress" />
              </AvGroup>
              <AvGroup>
                <Label id="postalCodeLabel" for="location-postalCode">
                  <Translate contentKey="doitApplicationApp.location.postalCode">Postal Code</Translate>
                </Label>
                <AvField id="location-postalCode" type="text" name="postalCode" />
              </AvGroup>
              <AvGroup>
                <Label for="location-country">
                  <Translate contentKey="doitApplicationApp.location.country">Country</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="location-client">
                  <Translate contentKey="doitApplicationApp.location.client">Client</Translate>
                </Label>
                <AvInput id="location-client" type="select" className="form-control" name="client.id">
                  <option value="" key="0" />
                  {clients
