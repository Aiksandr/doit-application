...
export const LocationDeleteDialog = (props: ILocationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="doitApplicationApp.location.delete.question">
        <Translate contentKey="doitApplicationApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
