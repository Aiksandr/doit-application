...
export const EmployeeDeleteDialog = (props: IEmployeeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="doitApplicationApp.employee.delete.question">
        <Translate contentKey="doitApplicationApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
