...
export const EmployeeDetail = (props: IEmployeeDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="doitApplicationApp.employee.detail.title">Employee</Translate> [<b>{employeeEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{employeeEntity.client ? employeeEntity.client.id : ''}</dd>
        </dl>
